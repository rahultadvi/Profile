          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${CONTACT_INFO.email}`} className="text-gray-800 hover:text-blue-600 transition">
                    {CONTACT_INFO.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href={`tel:${CONTACT_INFO.phone}`} className="text-gray-800 hover:text-blue-600 transition">
                    {CONTACT_INFO.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-800">{CONTACT_INFO.location}</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href={CONTACT_INFO.social.portfolio}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-md hover:shadow-lg transform hover:-translate-y-0.5 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
